    ...
    public function index()
    {
        ...
        foreach ($dataList['data'] as $key => $value) {
            if ($value['trace_id'] != "") {
                ...
                foreach ($res as $k => $v) {
                    if (is_array($v)) {
                        $dataList['data'][$key]['click_rate'] = $v['data']['data']['click_rate'];    //点击率
                        $dataList['data'][$key]['delivery_rate'] = $v['data']['data']['delivery_rate'];  //到达率
                    }
                }
            } else {
                $dataList['data'][$key]['click_rate'] = '0%';    //点击率
                $dataList['data'][$key]['delivery_rate'] = '0%';  //到达率
            }
